    ...
    <body>
        <section class="py-4 py-xl-5">
            <nav class="navbar navbar-light navbar-expand-md py-3"
                style="box-shadow: 0px 0px var(--bs-warning);margin-bottom: 50px;">
                <div class="container"><a class="navbar-brand d-flex align-items-center" href="index.html"><span><img
                    ...
                    <div class="d-none d-md-block"><a class="btn btn-light me-2" role="button"
                            style="--bs-secondary: #6c757d;--bs-secondary-rgb: 108,117,125;background: #c8ccd0;backdrop-filter: opacity(0.94) brightness(121%) contrast(76%);-webkit-backdrop-filter: opacity(0.94) brightness(121%) contrast(76%);--bs-body-font-size: 9rem;--bs-body-font-weight: bold;border-color: var(--bs-teal);box-shadow: 0px 0px var(--bs-yellow);padding-right: 11px;margin-left: -36px;"
                            href="login.html">LOGIN HERE</a></div>
                </div>
            </nav>
            <div class="container">
                <div class="row">
                    <div class="col"><iframe allowfullscreen="" frameborder="0" loading="lazy"
                            src="https://www.google.com/maps/embed/v1/place?key=AIzaSyCrJ0IP9dw0pM9MXgi7qX5g_tBUqAGIJEU&amp;q=500+E+Main+St%2C+Norfolk+VA+23510&amp;zoom=11&amp;maptype=satellite"

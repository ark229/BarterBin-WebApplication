...
<html lang="en">
    ...
    <body>
        <nav class="navbar navbar-light navbar-expand-md py-3" style="box-shadow: 0px 0px var(--bs-warning);">
            <div class="container"><a class="navbar-brand d-flex align-items-center" href="index.html"><span><img
                            src="assets/img/barter-bin-high-resolution-logo-color-on-transparent-background.png"
                            style="width: 352px;margin: 6px;padding: 0px;height: 219.469px;"></span></a><button
                ...
                <div class="collapse navbar-collapse flex-grow-0 order-md-first" id="navcol-4">
                    <div class="d-md-none my-2"><a class="btn btn-light me-2" role="button"
                            style="font-weight: bold;background: var(--bs-teal);">LOGIN</a></div>
                </div>
                <div class="d-none d-md-block"></div>
            </div>
        </nav>
        <div class="container" style="padding-bottom: 20px;width: 1160px;margin-top: 36px;">
            <div class="row">
                <div class="col-md-12">
                    <h1 style="color: var(--bs-gray-600);">LOGIN HERE</h1>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-6">
                    <form action="" method="">
                        <input class="form-control form-control-lg" type="email"
                            style="width: 300px;height: 52px;margin-top: 10px;margin-bottom: 10px;"
                            placeholder="Email Address" required="">
                        <input class="form-control form-control-lg" type="password"
                            style="width: 300px;height: 52px;margin-top: 10px;margin-bottom: 10px;"
                            placeholder="Password" required="" minlength="6" maxlength="20">
                        <input class="btn btn-lg btn-primary" type="submit"
                            style="width: 220.5px;height: 53px;margin-top: 10px;margin-bottom: 10px;background: var(--bs-orange);">
                    </form>
                </div>
                <div class="col-md-6">
                    <p style="margin-left: 50px;font-size: 25px;color: var(--bs-gray-700);"><a href="#"
                            style="color: var(--bs-gray-800);">Forgot Password?</a></p>
                    <p style="font-size: 25px;margin-left: 50px;margin-top: 30px;color: var(--bs-gray-800);">Don't have
                        an account?</p>
                    <p style="margin-left: 50px;margin-top: 0px;margin-bottom: 0px;padding-top: 10px;"><a
                            href="register.html" style="color: var(--bs-gray-800);font-size: 25px;">Register Here.</a>
                    </p>
                </div>
            </div>
        </div>

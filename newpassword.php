...
<body>
        ...
        <div class="container"><a class="navbar-brand d-flex align-items-center" href="index.php" style="width: 340px;height: 230px;"><img src="assets/img/barter-bin-high-resolution-logo-color-on-transparent-background.png" style="width: 330px;"></a><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-2"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse" id="navcol-2">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item"><a class="nav-link active" href="register.php" style="font-weight: bold;color: var(--bs-green);font-size: 25px;">Register</a></li>
                    <li class="nav-item"><a class="nav-link" href="login.php" style="color: var(--bs-green);font-weight: bold;font-size: 25px;">Login</a></li>
                    <li class="nav-item"><a class="nav-link" href="contact.php" style="color: var(--bs-green);font-weight: bold;font-size: 25px;">Contact</a></li>
                </ul>
            </div>
        </div>
    </nav>
    ...
    <div class="container" style="margin-top: 50px;margin-bottom: 20px;">
        <div class="row">
            ...
            <div class="col-md-4">
                <form action="" method="post"><label class="form-label" style="font-size: 20px;">Enter your new password:</label><input class="form-control form-control-lg" name="passwd" type="password"><input class="btn btn-primary" type="submit" value="Submit" style="width: 416px;height: 60px;margin-top: 10px;margin-bottom: 10px;color: var(--bs-white);font-size: 27px;background: var(--bs-teal);font-weight: bold;"></form>
            </div>
            <div class="col-md-4"></div>
        </div>
    </div>

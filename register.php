...
<html lang="en">
  ...
  <body>
    <nav
      ...
      style="box-shadow: 0px 0px var(--bs-warning)"
    >
      <div class="container">
        ...
        >
          <div class="d-md-none my-2">
            <a
              ...
              role="button"
              style="font-weight: bold; background: var(--bs-teal)"
              >LOGIN</a
            >
          </div>
        </div>
    ...
    <div class="container" style="margin-top: 20px">
      <div class="row">
        <div class="col-md-12" style="padding-right: 12px">
          <h1 style="text-align: center; color: var(--bs-gray-700)">
            Become a Barter Buddy today.
          </h1>
          <h1
            style="text-align: center; color: var(--bs-orange); font-size: 35px"
          >
            Register Now!
          </h1>
          <p
            ...
            "
          >
            Separate your needs &amp; offers with a comma:&nbsp;<span
              style="color: var(--bs-green); font-style: italic"
              >washer, oven, roughly used car</span
            >
          </p>
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-md-4" style="margin-left: 0px; margin-top: 20px">
          <form
            action=""
            method="POST"
            style="margin-left: 51px; margin-right: 0px; margin-bottom: 0px"
          >
            <input

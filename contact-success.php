...
<body style="
    ...
    <nav class="navbar navbar-light navbar-expand-md py-3" style="box-shadow: 0px 0px var(--bs-warning)">
        <div class="container">
            <a class="navbar-brand d-flex align-items-center" href="index.php"><span><img src="assets/img/barter-bin-high-resolution-logo-color-on-transparent-background.png" style="
                width: 352px;
                margin: 6px;
                padding: 0px;
                height: 219.469px;
              " /></span></a><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-4">
...
-->
    ...
    <div class="d-flex d-lg-flex justify-content-center align-items-center justify-content-lg-center align-items-lg-center highlight-blue" id="About" style="height: 100px; background-color: rgba(255, 255, 255, 0.9)">
        <div class="container">
            <div class="buttons">
                <a class="btn text-capitalize" role="button" href="index.php" style="
              color: #ffffff;

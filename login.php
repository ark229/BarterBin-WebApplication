        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <form action="login-process.php" method="post">
                    <input class="form-control form-control-lg" name="email" type="email" style="width: 300px;height: 52px;margin-top: 10px;margin-bottom: 10px;" placeholder="Email Address" required="">
                    <input class="form-control form-control-lg" name="passwd" type="password" style="width: 300px;height: 52px;margin-top: 10px;margin-bottom: 10px;" placeholder="Password" required="" minlength="6" maxlength="20">
            ...
            <div class="col-md-6">
                <p style="margin-left: 50px;font-size: 25px;color: var(--bs-gray-700);"><a href="password.php" style="color: var(--bs-gray-800);">Forgot Password?</a></p>
                <p style="font-size: 25px;margin-left: 50px;margin-top: 30px;color: var(--bs-gray-800);">Don't have
                    an account?</p>
                <p style="margin-left: 50px;margin-top: 0px;margin-bottom: 0px;padding-top: 10px;"><a href="register.php" style="color: var(--bs-gray-800);font-size: 25px;">Register Here.</a>
                </p>
            </div>
        </div>
    </div>

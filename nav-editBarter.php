...
<head>
    ...
    <title>Bargin Bin - Edit Barter</title>
    </title>
            ...
            <div class="collapse navbar-collapse" id="navcol-2">
                <ul class="navbar-nav ms-auto">
                    <?php if (isset($_SESSION['user_id'])) : ?>
                        <li class="nav-item"><a class="nav-link active" href="main.php" style="font-weight: bold;color: var(--bs-green);font-size: 20px;">View Barter</a></li>

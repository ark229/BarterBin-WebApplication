...
<html lang="en">
  ...
  <body>
    <nav class="navbar navbar-light navbar-expand-md py-3" style="box-shadow: 0px 0px var(--bs-warning)">
      <div class="container">
        <a class="navbar-brand d-flex align-items-center" href="index.html"><span><img
              src="assets/img/barter-bin-high-resolution-logo-color-on-transparent-background.png" style="
                width: 352px;
                margin: 6px;
                padding: 0px;
                height: 219.469px;
    ...
    <div class="col-md-12" style="padding-bottom: 0px; padding-top: 30px">
      <h1 style="
          ...
          padding-bottom: 23px;
        ">
        You are almost there!!! Let's keep going...
      </h1>
    </div>
    <div class="container">
      <div class="row">
